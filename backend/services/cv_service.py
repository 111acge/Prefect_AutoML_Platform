...
def get_cv_splitter(
    ...
    Args:
        ...
        min_class_count: 分类任务最小类样本数，用于限制 StratifiedKFold 折数
    ...
    if task_type in ("binary_classification", "multiclass_classification") and min_class_count is not None:
        ...
        n_folds = max(2, min(n_folds, int(min_class_count)))
